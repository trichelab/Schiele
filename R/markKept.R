...
#' @param ...           additional arguments to be passed to emptyDrops
#' 
...
#' 
#' @export
markKept <- function(sce, targetCells=20000, targetUMIs=50, ...) {

  sce$UMIs <- colSums(counts(sce))
  tally <- sort(sce$UMIs, decreasing=TRUE)
